...
def get_images_masks(file):
    try:
        ...
        for i in range(OPL.shape[0]):
            ...
            # ELM
            # mask[ELM[i]:PR1[i], i] = 1 if ELM[i] <= PR1[i] and ELM[i] > 0 and PR1[i] > 0 else mask[ELM[i]:PR1[i], i]
            # EZ
...
def main():
    id_train = ['8837', '45954', '48104', '35282', 'IRD_RPE65_13', '35281',  'IRD_RPE65_22', '10162', '29331', '35280', '51208',
                '20952', '52372', 'IRD_RPE65_02', '52374', 'IRD_RPE65_10',  'IRD_RPE65_07', 'IRD_RPE65_16', '52113', '49031', '52065',
                'IRD_RPE65_01', '49905', '35821', '42979', '51155', '52037', 'IRD_RPE65_06', '49883', 'IRD_RPE65_15', '16834',
                 'IRD_RPE65_18', '35897', 'IRD_RPE65_08', 'IRD_RPE65_09',  '52051', 'IRD_RPE65_04',
                '30518', '40300', '48782', 'IRD_RPE65_05', 'IRD_RPE65_12', 'IRD_RPE65_03', '51021', '49699', '28008', '26472',
                '51886', '52009', 'IRD_RPE65_17',  '52386', 'IRD_RPE65_23', '49919', '49885',
                'IRD_RPE65_11', 'IRD_RPE65_21', '52458', '49759', 'IRD_RPE65_19', 'IRD_RPE65_20']

    id_val = ['52025', '6627', '15313', '51013', '23028', '52484', '44872', '51904', '35277', '51812', 
              '33996', '35328', '21509', '51038', '51939',  '43781', '51870', '34571', '48731', '16831']

    IDs = []
    filenames_oct = get_filenames('OCT_DATASET/dataset/OCT3/', 'vol')
    sum = 0.0
    squared_sum = 0.0
    for idx, f1 in enumerate(tqdm(filenames_oct)):
        ...
        base_path = 'OCT_DATASET/dataset/PatientIDs128_OPL2ELM2BM/'
