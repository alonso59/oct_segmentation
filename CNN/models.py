...
from networks.SUNet import SUNet_model
...
class SegmentationModels(nn.Module):
    ...
    def SwinUnet(self,
        ...
        if pretrain:
            ...
            self.model.load_from("CNN/pretrained/swin_tiny_patch4_window7_224.pth", self.device)
        return self.model, None
    ...
    def sunet(self,
        ...
        self.model = SUNet_model(img_size=self.img_size,
                                 patch_size=4,
                                 num_classes=self.n_classes,
                                 embed_dim=embed_dim,
                                 depths=depths,
